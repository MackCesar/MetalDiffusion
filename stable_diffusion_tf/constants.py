PYTORCH_CKPT_MAPPING = {'text_encoder_legacy': [('cond_stage_model.transformer.text_model.embeddings.token_embedding.weight',
   None),
  ...
  'text_encoder': [('cond_stage_model.model.token_embedding.weight',
   None),
